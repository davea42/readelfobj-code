...
/* These from cctools in mach/machine.h and our config.h */
#define cpu_type_t    DW_TYPEOF_32BIT
#define cpu_subtype_t DW_TYPEOF_32BIT
#define vm_prot_t     DW_TYPEOF_32BIT
